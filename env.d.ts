/* eslint-disable */
// Generated by Wrangler by running `wrangler types --env-interface=CloudflareEnv env.d.ts` (hash: 0b702433a1598dddf6eda5d014f8f565)
// Runtime types generated with workerd@1.20260701.1 2026-07-03 global_fetch_strictly_public,nodejs_compat
interface __BaseEnv_CloudflareEnv {
  IMAGES: ImagesBinding;
  ASSETS: Fetcher;
  NEXT_PUBLIC_URL: "https://mysatprep.aldhanekadev.workers.dev";
  BETTER_AUTH_URL: "https://mysatprep.aldhanekadev.workers.dev";
  BETTER_AUTH_TRUSTED_ORIGINS: "https://mysatprep.fun,https://mysatprep.aldhanekadev.workers.dev,http://localhost:3000,http://localhost:5173";

  AUTHENTICATION_CB_MYPRACTICE: string;
  CB_MYPRACTICE_SESSION_ID: string;
  DATABASE_URL: string;
  ...
  WORKER_SELF_REFERENCE: Fetcher /* mysatprep */;
}
...
declare namespace NodeJS {
  interface ProcessEnv extends StringifyValues<
    Pick<
      ...
      | "NEXT_PUBLIC_URL"
      | "BETTER_AUTH_URL"
      | "AUTHENTICATION_CB_MYPRACTICE"
      | "CB_MYPRACTICE_SESSION_ID"
      | "DATABASE_URL"
